    ...
    <div>
      <section className="relative overflow-hidden bg-slate-950">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-24 text-center sm:py-32">
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            <Link href="/browse" className="rounded-lg bg-white px-6 py-3 font-semibold text-slate-900 shadow-lg shadow-brand-500/20 transition hover:bg-slate-100">
              Find a tutor
            </Link>
            <Link href="/dashboard/tutor" className="rounded-lg border border-white/20 bg-white/5 px-6 py-3 font-semibold text-white backdrop-blur transition hover:bg-white/10">
              Start teaching
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((f) => (
            <div key={f.title} className="group rounded-2xl border border-slate-200 bg-white p-6 transition hover:-translate-y-0.5 hover:shadow-lg hover:shadow-slate-200/60">
