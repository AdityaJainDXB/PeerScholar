...
fun CourseDetailScreen(courseId: String) {
    ...
    Column(Modifier.fillMaxSize().verticalScroll(rememberScrollState()).padding(16.dp)) {
        ...
        Box(
            Modifier.fillMaxWidth().height(180.dp).background(Color.Black, RoundedCornerShape(14.dp)),
            contentAlignment = Alignment.Center,
        ) {
            Text("Preview: Lesson 1 video player", color = Color.White.copy(alpha = 0.7f))
        }
