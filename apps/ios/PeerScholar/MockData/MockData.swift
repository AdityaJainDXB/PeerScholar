...
enum MockData {
    ...
    static let courses: [Course] = [
        ...
        Course(id: "c5", tutorId: "t1", tutorName: "Maya Chen", subject: "AP Calculus AB",
               title: "AP Calculus AB: Derivatives Deep Dive",
               description: "A focused course on differentiation rules, implicit differentiation, and related rates.",
               priceCents: 3500, status: .published, lessonCount: 14, totalDurationMinutes: 210,
               ratingAvg: 4.8, ratingCount: 9, enrollmentCount: 47,
    ...
    static let liveSessions: [LiveSession] = [
        ...
        LiveSession(id: "s4", tutorId: "t1", tutorName: "Maya Chen", subject: "AP Calculus BC",
                    title: "Live Review — Series Convergence Tests",
                    description: "Walking through the ratio, root, and comparison tests.",
                    priceCents: 0, scheduledAt: Date().addingTimeInterval(3600 * 4),
                    durationMinutes: 50, maxParticipants: 30, bookedCount: 21, status: .scheduled,
                    joinUrl: "https://meet.peerscholar.app/s4"),
    ]

    static let earningsHistory: [WeeklyEarning] = [
        WeeklyEarning(label: "Wk 1", cents: 18400),
        WeeklyEarning(label: "Wk 2", cents: 21200),
        WeeklyEarning(label: "Wk 3", cents: 19800),
        WeeklyEarning(label: "Wk 4", cents: 26500),
        WeeklyEarning(label: "Wk 5", cents: 31200),
        WeeklyEarning(label: "Wk 6", cents: 29700),
    ]
}
